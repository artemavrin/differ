import {QuickPickItem, QuickInputButton, QuickInput, window, QuickInputButtons, Disposable} from "vscode";
...
export class MultiStepInput {
	...
	async showInputBox<P extends InputBoxParameters>({ title, step, totalSteps, value, prompt, validate, buttons, ignoreFocusOut, placeholder, shouldResume, password }: P) {
		const disposables: Disposable[] = [];
		try {
